	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 27:
				...
				else if (ch == 92) {AddCh(); goto case 30;}
				else {goto case 0;}
			case 28:
				recEnd = pos; recKind = 51;
				if (ch >= '0' && ch <= '9') {AddCh(); goto case 10;}
				else if (ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 31;}
				else {t.kind = 51; break;}
			case 29:
			...
			case 36:
				{t.kind = 6; break;}
			case 37:
				if (ch == 'c') {AddCh(); goto case 38;}
				else {goto case 0;}
			case 38:
				if (ch == 'o') {AddCh(); goto case 39;}
				else {goto case 0;}
			case 39:
				if (ch == 'p') {AddCh(); goto case 40;}
				else {goto case 0;}
			case 40:
			...
			case 46:
				{t.kind = 27; break;}
			case 47:
				if (ch == 'u') {AddCh(); goto case 48;}
				else {goto case 0;}
			case 48:
				if (ch == 't') {AddCh(); goto case 49;}
				else {goto case 0;}
			case 49:
				if (ch == 'o') {AddCh(); goto case 50;}
				else {goto case 0;}
			case 50:
